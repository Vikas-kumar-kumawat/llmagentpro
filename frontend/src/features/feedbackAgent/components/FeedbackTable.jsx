        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`py-1.5 pl-8 pr-3 rounded-xl text-xs font-medium border focus:outline-none transition w-full sm:w-44 md:w-52 ${
                isDark
          ...
          <div className="relative">
            <select
              ...
              className={`py-1.5 pl-3 pr-8 rounded-xl text-xs font-semibold appearance-none border cursor-pointer focus:outline-none transition ${
                isDark 
          ...
          {isBatchCalling ? (
            <button
              ...
              className="px-3 py-1.5 rounded-xl text-xs font-bold bg-rose-600 hover:bg-rose-500 text-white shadow-xs transition flex items-center gap-1 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl text-xs font-bold bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white shadow-xs transition flex items-center gap-1 cursor-pointer"
            >
