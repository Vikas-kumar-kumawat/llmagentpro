...
export function FeedbackVoiceBanner({ voicePersona, setVoicePersona, isPlayingDemo, handlePlayDemo }) {
  ...
  return (
    <div className={`p-3.5 sm:p-4 rounded-2xl border mb-4 sm:mb-6 transition-all ${isDark ? 'bg-[#080808] border-[#181818]' : 'bg-white border-slate-100 shadow-sm'
      }`}>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2 w-full md:w-auto">
          <div className="relative w-full sm:w-auto">
            <select
              ...
              className={`w-full py-2 sm:py-1.5 pl-3 pr-8 rounded-xl text-xs font-medium border cursor-pointer focus:outline-none transition ${isDark
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <button
              ...
              className={`flex-1 sm:flex-none justify-center px-3 py-2 sm:py-1.5 rounded-xl text-xs font-bold transition flex items-center gap-1.5 cursor-pointer border ${isPlayingDemo
            ...
            <button
              ...
              className={`flex-1 sm:flex-none justify-center px-3 py-2 sm:py-1.5 rounded-xl text-xs font-bold transition flex items-center gap-1.5 cursor-pointer border ${isDark
